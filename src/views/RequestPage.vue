...
const onScroll = () => {
  ...
  parallaxY.value = -Math.round(window.scrollY * 0.2);
};
onMounted(() => {
  onScroll();
...
const allImages = {
  bar: import.meta.glob("@/assets/pictures/raum/bar/*", {
    eager: true,
    import: "default",
  }),
  dj: import.meta.glob("@/assets/pictures/raum/dj/*", {
    eager: true,
    import: "default",
  }),
  tresor: import.meta.glob("@/assets/pictures/raum/tresor/*", {
    eager: true,
    import: "default",
  }),
  bar5: import.meta.glob("@/assets/pictures/raum/bar5/*", {
    eager: true,
    import: "default",
  }),
  orangerie: import.meta.glob("@/assets/pictures/raum/orangerie/*", {
    eager: true,
    import: "default",
  }),
};
  ...
  spots.map((spot) => ({
    ...
    images: spot.images?.length
      ? spot.images.map((f) =>
          f.startsWith("http")
            ? f
            : `${API_BASE}/uploads/rooms/${spot.imageFolder}/${f}`,
        )
...
const validate = () => {
  ...
  if (form.value.altDatum && !form.value.altDatumWert)
    errors.altDatumWert = "Bitte Alternativdatum auswählen";
  if (!form.value.datenschutz)
    errors.datenschutz = "Bitte Einverständnis geben";
...
<template>
  <MainLayout>
    <div ref="requestPageRef" class="request-page">
      ...
      <section class="hero-section">
        <div class="container hero-content">
          ...
          <div class="intro-text">
            <p>
              Das Pallas in der Schanze ist genau das, was du daraus machen
              möchtest. Unsere Fünf Bereiche können einzeln genutzt oder wahlweise miteinander kombiniert werden. Mehr zu unseren Räumen findest du in unserem interaktiven Raumplan.
              Anfragen werden über das untenstehende Formular entgegengenommen.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="container form-container">
          ...
          >
            ...
            <fieldset class="form-fieldset">
              ...
              <div class="form-grid">
                <div class="form-group full-width">
                  <label class="form-label" for="req-thema"
                    >Thema / Anlass *</label
                  >
                  <input
                    id="req-thema"
                    ...
                    type="text"
                    class="form-input"
                    :class="{ 'has-error': formErrors.thema }"
                  />
                  <span v-if="formErrors.thema" class="form-error">{{
                    formErrors.thema
                  }}</span>
                </div>

                <div class="form-group">
                  <label class="form-label" for="req-gaeste"
                    >Gästeanzahl *</label
                  >
                  <input
                    id="req-gaeste"
                  ...
                  />
                  <span v-if="formErrors.gaeste" class="form-error">{{
                    formErrors.gaeste
                  }}</span>
                </div>

                <div class="form-group">
                  <label class="form-label" for="req-budget"
                ...
                <div class="form-group">
                  ...
                  <input
                    ...
                    type="date"
                    class="form-input"
                    :class="{ 'has-error': formErrors.datum }"
                  />
                  <span v-if="formErrors.datum" class="form-error">{{
                    formErrors.datum
                  }}</span>
                </div>
                ...
                <div class="form-group form-group-flex full-width">
                  ...
                  <div v-if="form.altDatum" class="alt-date-row">
                    <div class="alt-date-field">
                      <input
                        v-model="form.altDatumWert"
                        type="date"
                        class="form-input form-input-sm"
                        :class="{ 'has-error': formErrors.altDatumWert }"
                      />
                      <span v-if="formErrors.altDatumWert" class="form-error">{{
                        formErrors.altDatumWert
                      }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group dj-quelle-group full-width">
                  ...
                  <div class="dj-quelle-buttons">
                    <button
                      ...
                      @click="
                        form.djQuelle = form.djQuelle === 'ja' ? '' : 'ja'
                      "
                    >
                      Ja
                    </button>
                    <button
                      ...
                      @click="
                        form.djQuelle = form.djQuelle === 'nein' ? '' : 'nein'
                      "
                    >
                      Nein
                    </button>
              ...
              <div class="form-group rooms-group">
                ...
                <div class="rooms-choices">
                  ...
                  >
                    {{ room.label }}
                    <span v-if="room.capacity" class="room-chip-cap">{{
                      room.capacity
                    }}</span>
                  </button>
                </div>
            ...
            <fieldset class="form-fieldset">
              ...
              <div class="form-group full-width">
                <label class="form-label" for="req-nachricht"
                  >Deine Nachricht (optional)</label
                >
                <textarea
                  id="req-nachricht"
            ...
            <div class="form-group consent-group">
              <label
                class="form-checkbox"
                :class="{ 'has-error': formErrors.datenschutz }"
              >
                <input type="checkbox" v-model="form.datenschutz" />
                <span class="checkbox-box"></span>
                <span class="checkbox-text">
                  Ich bin einverstanden mit der Verarbeitung meiner Daten gemäß
                  der
              ...
              <span v-if="formErrors.datenschutz" class="form-error">{{
      ...
      <Teleport to="body">
        <div
          v-if="isModalOpen && !lightboxVisible"
          class="modal-overlay"
        ...
        >
          <div class="modal-content">
            ...
            <div class="room-details">
              <div
                class="detail-row"
                v-if="selectedSpot?.capacity || selectedSpot?.area"
              >
              ...
              <div
                v-if="selectedSpot?.features?.length > 0"
                class="detail-item features"
              >
            ...
            <div class="description-container">
              ...
              <button
                v-if="
                  selectedSpot?.description &&
                  selectedSpot.description.length > 150
                "
                class="read-more-btn"
