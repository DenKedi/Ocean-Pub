        ...
        <div class="instagram-column instagram-column-left">
          ...
          <div v-if="!consentGiven" class="instagram-post post-left instagram-facade theme-container-bg">
            <div class="facade-inner">
              ...
              <p class="facade-hint theme-text-muted">Mehr Infos in der <NuxtLink to="/datenschutz" class="facade-link">Datenschutzerklärung</NuxtLink>.</p>
            </div>
          </div>
...
onMounted(async () => {
  try {
    ...
    const { data } = await axios.get(`${config.public.apiBaseUrl}/settings`)
